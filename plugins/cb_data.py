...
app = Client("ghoatX", api_id=API_ID, api_hash=API_HASH, session_string=STRING_SESSION)
...
async def doc(bot, update):
    ...
    try:
        path = await bot.download_media(message=file, progress=progress_for_pyrogram, progress_args=(" Trying To Downloading...  ",  ms, c_time))
